...
class EseCase3(unittest.TestCase):
    ...
    def index(self):
        ...
        ese_to1 = browser.find_element_by_xpath('/html/body/div[2]/div[1]/div[1]/ul/li[12]/span')
    ...
    def test_main(self):
        self.index()
        PublicCase2_4.addressdetails_other_warehouse_login(self, self.ese_shipper_contactname, self.ese_shipper_company,

...
class EseCase3(unittest.TestCase):
    ...
    def setParameters(self,case_name,ese_from_postcode, ese_to_postcode, ese_weight, ese_length, ese_width,
                      ...
                      ese_pay_cardno, ese_pay_youxiaoqi, ese_pay_cvc, ese_pay_postcode,username,password, ese_successful):
        """
                从 excel 中获取用例
    ...
    def setUp(self):
        self._testMethodDoc = "</br>英国至非中国多商品单一收货人登录后下单:</br>" + self.case_name  # 设置用例名称
    ...
    def parcel_content_multiplegoods_singlereceiver(self):
        ...
        time.sleep(10)
        ese_user_email = browser.find_elements_by_xpath('//*[@class="el-input__inner"]')[20]
        ese_user_email.send_keys(self.username)
        ese_user_pwd = browser.find_elements_by_xpath('//*[@class="el-input__inner"]')[21]

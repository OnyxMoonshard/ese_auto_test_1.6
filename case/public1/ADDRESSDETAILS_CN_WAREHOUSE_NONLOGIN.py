...
class PublicCase3_1(unittest.TestCase):
    ...
    def addressdetails_china_warehouse_nonlogin(self, ese_shipper_contactname, ese_shipper_company, ese_shipper_addr1,
        ...
        ese_shipper_state1 = browser.find_elements_by_xpath('//*[@class="el-input__inner"]')[3]

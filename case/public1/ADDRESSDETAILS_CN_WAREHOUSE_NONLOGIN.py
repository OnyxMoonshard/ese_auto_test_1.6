...
class PublicCase1(unittest.TestCase):
    ...
    def aDDRESSDETAILS_CN_WAREHOUSE_NONLOGIN(self,ese_shipper_contactname,ese_shipper_company,ese_shipper_addr1,
        ...
        '''到中国、未登录、Warehouse'''
        browser = self.driver
        ese_shipper_contactname1 = browser.find_elements_by_xpath('//*[@class="el-input__inner"]')[2]
        ...
        ese_shipper_company1 = browser.find_elements_by_xpath('//*[@class="el-input__inner"]')[3]
        ...
        ese_shipper_state1 = browser.find_elements_by_xpath('//*[@class="el-input__inner"]')[8]
        ese_shipper_state1.clear()
        ese_shipper_state1.send_keys(str(ese_shipper_zipcode))
        
        ese_shipper_email1 = browser.find_elements_by_xpath('//*[@class="el-input__inner"]')[9]
        ese_shipper_email1.send_keys(str(ese_shipper_email))
        
        ese_shipper_phone1 = browser.find_elements_by_xpath('//*[@class="el-input__inner"]')[10]
        ese_shipper_phone1.send_keys(int(ese_shipper_phone))
        
        ese_receiver_contactname1 = browser.find_elements_by_xpath('//*[@class="el-input__inner"]')[11]
        ese_receiver_contactname1.send_keys(str(ese_receiver_contactname))
        
        ese_receiver_company1 = browser.find_elements_by_xpath('//*[@class="el-input__inner"]')[12]
        ...
        ese_receiver_district1 = browser.find_elements_by_xpath('//*[@class="el-input__inner"]')[18]
        ese_receiver_district1.send_keys(str(ese_receiver_zipcode))
        
        ese_receiver_email1 = browser.find_elements_by_xpath('//*[@class="el-input__inner"]')[19]
        ese_receiver_email1.send_keys(str(ese_receiver_email))
        
        ese_receiver_phone1 = browser.find_elements_by_xpath('//*[@class="el-input__inner"]')[20]
